...
namespace LazyPanClean {
    public class LPInputRegister : LPSingleton<LPInputRegister> {
        ...
        public void Load(string actionName, Action<InputAction.CallbackContext> action) {
            if (inputActionAsset == null) { 
                inputActionAsset = LPLoader.LoadAsset<InputActionAsset>(AssetType.INPUTACTIONASSET, inputControlKey);
            }
