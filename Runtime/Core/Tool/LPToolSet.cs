...
#if UNITY_EDITOR
    public class LPToolSet : EditorWindow {
        ...
        public static void CollectPointsToSetting() {
            ...
            //创建点位配置
            string settingPath = string.Concat("Assets", LPLoader.LoadGameSetting().LocationInformationSettingPath, selectGameObject.name, ".asset");
            LPLocationInformationSetting setting = AssetDatabase.LoadAssetAtPath(settingPath, typeof(LPLocationInformationSetting)) as LPLocationInformationSetting;
            if (setting == null) {
                setting = CreateInstance<LPLocationInformationSetting>();
        ...
        public static void CreatePointsToSetting() {
            ...
            List<LPLocationInformationSetting> locationInformationSetting = new List<LPLocationInformationSetting>();
            foreach (Object obj in Selection.objects) {
                locationInformationSetting.Add(obj as LPLocationInformationSetting);
            }

            foreach (LPLocationInformationSetting setting in locationInformationSetting) {
                ...
                for (int i = 0; i < setting.locationInformationDatas.Count; i++) {
                    ...
                    GameObject childGameObject = LPLoader.LoadGo(string.Concat(markSign, "_", i),
