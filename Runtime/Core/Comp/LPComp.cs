...
namespace LazyPanClean {
    public class LPComp : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerDownHandler, IPointerUpHandler, IPointerClickHandler {
        ...
        public T Get<T>(string sign) where T : Object {
            ...
            } else if (typeof(T) == typeof(LPComp)) {
                foreach (CompData compData in Comps) {
                    if (compData.Sign == sign) {
                        return compData.lpComp as T;
                    }
                }
        ...
        public class CompData {
            public string Sign;
            [FormerlySerializedAs("Comp")] public LPComp lpComp;
        }
